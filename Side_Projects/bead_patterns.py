...
#
#def pixelate(original, new):
#    
#    new = original / 3
#    
#    return new
#
#pixelate(o_reds, new_reds)


# Simple case to test out
#test_reds = [[82, 0, 82, 82],[82, 82, 82, 79],
#             [82, 82, 82, 47],[82, 90, 82, 82]]
#test_greens = [[179, 0, 136, 136],[179, 39, 179,180],
#               [179, 179, 179, 229],[179, 200, 179, 179]]
#test_blues = [[243, 0, 44, 44],[243, 243, 243, 52],
#              [243, 243, 102, 47],[243, 39, 243, 243]]
#test_result = np.stack([test_reds, test_greens, test_blues], 
#                       axis=2).astype(np.uint8)
##test_result = np.dtype=np.uint8
